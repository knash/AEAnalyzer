...
batchesperfile={"TT":3,"QCD_HT1000to1500":5,"QCD_HT1500to2000":5,"QCD_HT2000toInf":5}

#Keep only the branches you want "Jet",["pt"] would be the branch Jet_pt in the NanoAOD
branchestokeep=OrderedDict([("Jet",["pt","eta","phi","mass"]),("FatJet",["pt","eta","phi","mass","msoftdrop","hadronFlavour","iAEMSE","iAEL0","iAEL1","iAEL2","iAEL3","iAEL4","iAEL5"]),("",["run","luminosityBlock","event"])])

#Trim out element indices you dont want (ie only keep top 5 jets etc)
mind={"FatJet":5,"Jet":15,"Muon":5,"":None,"HLT":None}
